...
DPI = 150          # scan resolution for OCR (150 balances quality vs token limit)
MAX_TOKENS = 4096  # max response tokens
JPEG_QUALITY = 75  # quality for base64-encoded images sent to API
MAX_IMAGE_DIM = 1024  # max width or height in pixels before resizing
