...
**ggmaps:** This excellent package provides support for much of what's done here. To learn more about the origin of ggmaps, visit https://journal.r-project.org/archive/2013-1/kahle-wickham.pdf
...
\[Move color lookup later\]

***Color Lookup Table:** This is a simple two-column table that allows the generation of a new column in the Map Table where values in one column (such as an index number) are converted to a color. This table is used primarily when quantitative values are being segmented so that data ranges can be displayed as colors.*
...
This key points: think tables and recognize the importance of standard column names.
