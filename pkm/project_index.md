...
**Active Focus (2026-09-01, close): "Smart_Car" -- CH.8 THROUGH CH.13 DRAFTED IN ONE DAY, AND CH.13's STATE COUNT HAD TO BE CORRECTED AGAINST THE PROJECT'S OWN FINDINGS.**
...
**★★★ KIM GAVE CH.12 ITS ENDING: THE INSTRUMENT-DESIGN LESSON.** *"What would have been better is to think through, ahead of time, what answers I'd like to get... Run the data early and often."* ★★★ **The cost is exact: TwoRed has no stopped-time column, so 139 of 223 legs (62.3%) can never be asked** -- **the one loss better analysis cannot repair.** ⚠ **A category dropdown built in 2010 would have held *somebody to see* and NOT Tom or Cindy**, so the chapter passes on a PAIR: design the columns you can foresee, AND keep one box with no rules in it. ★★★ **Run-it-early is MEASURABLE: 6 of 7 categories appear in the first TEN comments, all 7 by the 20th.**

**⚠ Pre-ship sweep of `R/` covers BOTH em dashes and hardcoded chapter numbers** -- each has shipped from an R string literal. ⚠ **View the PNG, and SEND it to Kim in the same turn.** ★★★ **And ask of every figure: if a reader saw only the shapes and no words, what would they think it was about?** I put the exception in the heaviest ink and it read as the thesis.

**NEXT: ch.14 `what_the_record_cannot_say.qmd`, the last chapter. ⛔ READ Findings 036, 041, 043, 044, 045 FIRST (Finding 052). ⛔ ASK KIM FOR THE TWORED-AT-THE-FLORIDA-CORNER PHOTO. Open: does PEI belong to the province count? Queued: the FUEL-STOP POINT MAP, which shows the 300-mile cadence a choropleth cannot, blocked on extending the gazetteer. Ch.6-ch.11 and ch.13 still unread by Kim. Nothing is blocking.**

**★★★ CH.13 THE TWO CONSTELLATIONS.** ⚠⚠⚠ **FIRST DRAFT CONTRADICTED THREE SETTLED FINDINGS -- Finding 052.** I re-derived the state count from the fuel log (43) and printed *"FL, RI, SD never witnessed"*; **the project settled 49 of 49 on 2026-08-21.** **Corrected: 43 fills, +MD/VT trip log = 45 documented, +DE/RI/SD arithmetic, +FL photograph = 49.** ★★★ **Kim then closed BC (one road north out of Haines), VT (followed a friend home from his NH office) and gave FL a photo of TwoRed at the corner.** ★★★ **His rule is the chapter's spine: _"strict with the data, but circumstances that are clearly explained do count."_ A fuel log doesn't record where a car went; it records where a driver bought petrol.** ★★★ **AND HE RULED ON THE MAP: it is about TRAVEL, not transactions.** The outlined no-fill states drew the eye and made absence look like the subject. **Rebuilt on reach -- two fills, nothing outlined; BC moved into the shared class.** ★★ **VT now has THREE instruments, the third an AMEX line (Quechee VT, 2014-05-19).** *The card statement caught the dinner because dinner is a thing you stop for.* ★★★ **THE PARKING MAP STANDS: 2,209 days, driven on 139 (6.3%); 91.9% in twelve gaps**, three holding **12,371 unlogged miles**.
<!-- /active-focus -->
