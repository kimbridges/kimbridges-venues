...
**Active Focus (2026-09-01, close): "Smart_Car" -- CH.8 THROUGH CH.13 DRAFTED IN ONE DAY; CHAPTER NUMBERS FIXED; AND THE SCAFFOLDS ARE PROVED TO ROT.**

**Foreword + ch.1-ch.12 stand, about 25,700 words. 16 chapters render, 0 error strings, 0 unresolved references.** Full detail in `session_log.md` 2026-09-01; Kim's accounts and rulings verbatim in `logs/proj_Smart_Car_log.md`.
...
**★★★ FINDING 051 -- KEEP THE GENERATOR, NOT THE RESULT -- EARNED ITS KEEP TEN TIMES TODAY.** Written after a scaffold's PARAPHRASE of Finding 033 turned out to be the version queued for print. **The ch.10, ch.11, ch.12 and ch.13 scaffolds then yielded nine more drifts** -- most recently median leg 251/166 mi where the truth is **305 and 273.7**, dormancy **86% where it is 91.9%**, and **both** recorded versions of the four missing states wrong. **Roughly half of every hand-copied scaffold is wrong, and the rate does not fall as the practice gets more careful.** ★ Corollary: **a round phrase that feels true is the same defect** -- caught "nine days in ten" in my own ch.12 draft.

**CH.8-CH.11, in one line each** (detail in `session_log.md`). **8, the hinge:** the record cannot see the driver, and **Kim's own correction proves it** (*"I couldn't go slow, the big vehicles kept moving at highway speeds"*: the speed IS the stress); a triple -- fear, tedium, pleasure, all at or above the median. **9, the paper:** the first photographic figure; ⚠ **Kim corrected the 0/8 mechanism -- it was the PRINTED RECEIPTS, not his hand** (★★★ *a shape in the data points at a PROCESS, not a PERSON*); ★★ and he gave it its ending, **the SCANNING EXPERIMENT**, which turned 7 typed rows into 139 legs. **10, the audit:** ★★★ **the tolerance is DERIVED, not chosen**, and **the finding is the GAP** -- 0.76c to 2.93c with nothing between, so no judgment call is ever required. **11, the cost:** ★★★ **39.25 against 39.66 mpg, four tenths apart** across sixteen years and two coasts; the 26% cost gap is 28% fuel price, by identity. ⚠ Every price in the book is a PREMIUM price.




**★★★ CH.12 A DAY IN A SMART -- THE FREE-TEXT COLUMN IS THE SHARPEST INSTRUMENT IN THE BOOK.** Creamsicle's `comment` box had no instructions and no requirement; Kim filled it on **35 of 84 legs by whim**, and those legs carry **73.4% of all stopped time** (p = 2.4e-07). **The three-way test is the result: same miles (272 vs 276, p = 0.97), different gross speed (38.1 vs 49.4, p = 0.002), same NET speed (47.3 vs 51.6, p = 0.36).** Same distance, same driving; **the whole difference is time the car stood still.** ★★ **A column nobody designed as an instrument separates the record better than the column that was** -- the stopped-time cell reads zero on *"Ferry, park, shop."* ⚠ Three of the four zero-stop comments are time-zone notes: **the column doing a second job, false positives that announce themselves.** ⚠ The category grouping is MINE and the chapter says so.

**★★★ AND KIM GAVE CH.12 ITS ENDING: THE INSTRUMENT-DESIGN LESSON.** *"At the start, I didn't know what to record... What would have been better is to think through, ahead of time, what answers I'd like to get... Planning ahead pays great dividends. Besides that, don't put off the analysis. Run the data early and often."* ★★★ **The cost of not planning is now EXACT and it is the largest number in the chapter: TwoRed has no stopped-time column, so 139 of the fleet's 223 legs -- 62.3% -- can never be asked.** ★★ **The one class of loss better analysis cannot repair:** an error corrects and a missing entry recovers from a scan; **a column that was never on the page recovers from nothing.** ⚠ **I named a tension in his lesson rather than smoothing it, and he should rule:** a category dropdown built in 2010 would have held *somebody to see* and NOT **Tom, Cindy, Meet Lan** -- `DAY_CATS` was derived by reading the free text. **So the chapter passes on a PAIR: design the columns you can foresee, AND keep one box with no rules in it.** ★★★ **And his run-it-early rule proved MEASURABLE: 6 of 7 categories appear in the first TEN comments, all 7 by the 20th, with 15 still to come.** Not advice, a result.

**⚠ The pre-ship sweep of `R/` must cover BOTH em dashes and hardcoded chapter numbers** -- each has now shipped from an R string literal (`fig_cost.R` titles; `constellations_data.R` table cells). ⚠ And **view the PNG before shipping a caption**: two have now been wrong about their own figure.

**NEXT: Kim reads ch.13 (and ch.6-ch.12, still unread). Then ch.14 `what_the_record_cannot_say.qmd`, the last chapter -- re-derive its scaffold numbers first. Open for a ruling: the ch.12 `@tbl-day` Madness row, and whether TwoRed crossed BC. Nothing is blocking.**

**★★★ CH.13 THE TWO CONSTELLATIONS -- 43 states + 10 provinces have a FILL, and the six silences are THREE KINDS.** **MD and VT were driven through and never filled** (recovered only from the trip log, which exists because of the scanning experiment); **DE by arithmetic**; **FL, RI, SD by nothing**. **Reach: 46 of 50.** ⚠⚠ **BOTH recorded versions of the missing states were WRONG.** ★★★ **The book's one photograph is Frostburg, and Frostburg is in MARYLAND, blank on the map.** ★★★ **Creamsicle added not one US state**; all 19 were TwoRed's. ★★★ **The parking map: 2,209 days, driven on 139 (6.3%); the other 91.9% is twelve gaps** (scaffold said 86%). ⚠ **Three of the twelve are not parking: 12,371 unlogged miles**, ch.4's finding from the odometer. ⛔ Map is STATE-LEVEL by design; parking figure is a TIMELINE (Finding 041).
<!-- /active-focus -->
