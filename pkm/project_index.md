...
**NEXT: ch.14 `what_the_record_cannot_say.qmd`, the last chapter. ⛔ READ Findings 036, 041, 043, 044, 045 FIRST (Finding 052). ★★★ FOUR PHOTOS ARE NOW IN `images/TwoRed/` -- the Florida PAIR (welded by the DEAD END sign in both), West Quoddy Head, and **TwoRed entering ALBERTA, the last jurisdiction: a documented COMPLETION** for ch.14 or the Afterword. ⛔ ASK KIM WHERE CREAMSICLE'S COORDINATES LIVE -- its fuel-stop map is blocked at 39.9% and the Jul-2024 update reportedly carries lat/long. TwoRed's stop map is BUILT (87.1%). Ch.6-ch.11 and ch.13 still unread by Kim.**

**★★★ CH.13 THE TWO CONSTELLATIONS.** ⚠⚠⚠ **First draft contradicted three settled findings -- Finding 052.** **Corrected: 49 states (43 fills, +MD/VT trip log, +DE/RI/SD arithmetic, +FL photograph) and 11 provinces** -- ★★ **PEI is an ELEVENTH, not a substitution: Confederation Bridge in, Pictou ferry out, no tank bought, settled by a VISA motel bill.** ★★★ **THE CARD STATEMENTS ARE NOW A FIRST-CLASS INSTRUMENT -- four times they have held what no fuel log could** (VT dinner at Quechee, PEI motel, plus two audit uses). ★★★ **Kim's rule is the chapter's spine: _"strict with the data, but circumstances that are clearly explained do count."_ A fuel log doesn't record where a car went; it records where a driver bought petrol.** ★★★ **He also ruled the map is about TRAVEL, not transactions** -- outlined no-fill states made absence look like the subject. Rebuilt on reach; nothing outlined. ★★★ **PARKING MAP: 2,209 days, driven on 139 (6.3%); 91.9% in twelve gaps**, three holding **12,371 unlogged miles**.
<!-- /active-focus -->
