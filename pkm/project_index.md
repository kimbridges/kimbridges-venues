...
**Active Focus (2026-09-25, OPEN): VORONOI -- restructure and complete a separate Voronoi methods document (`proj_Voronoi.md`, NEW). Active / Ready. Kim's ruling: finish it BEFORE the trilogy discusses the technology; *Maps with Tiles* (MWT) then cites it.**
...
**Relation to MWT.** MWT keeps the concept (the missing map) and ONE worked example, Kipuka Puaulu, in its overlay chapter; the mechanics move to the Voronoi document, so MWT ch.5, 6, 9, 11 shrink to summary + reference. Detail: `ideas_three_documents.md` (2026-09-25). Koch Voronoi Next Steps 5-6 are absorbed; Tom's work becomes a credited domain.

**Paused: the trilogy** (capture only; all three outlined 2026-09-23; block in `logs/focus_history.md`). **Paused: icons** (Blocked on photographs).
...
| proj_kimbridges_documents.md | kimbridges-documents | Website (Netlify) | Live; **23 documents** — *Smart Car* PUBLISHED 2026-09-03 as the twenty-third (`/smart_car/`), the venue's first photography-led narrative and the first to carry a web-sizing build step; llm_examples 22nd, ai_podcasts 21st, *Voucher Labels* 20th. Venue ~420 MB. Landing page concept still designed, not built | 2026-09-03 |
| proj_kimbridges_fiction.md | kimbridges-fiction | Website (Netlify) | **LIVE 2026-06-26** at kimbridges-fiction.netlify.app — fifth content site, the fiction front door (illustrated flipbooks). Two pieces live: "My Name Is Nike" (25 pp, ~0.6 MB) + "Orbits" (183 pp). **Third piece PUBLISHED 2026-09-05: *Three Ways to Let Go of the Rice* (40 pp, 3.5 MB), the first native fiction piece since the site opened.** Hub front door (card + navbar + gateway) live | 2026-09-05 |
...
| proj_Koch_voronoi.md | Koch Voronoi Analysis | R tool | Phase 1 done; Phase 2 pending; folder renamed from Koch_voronoi_pgm 2026-05-27 ; **vegetation / general documentation moved to proj_Voronoi.md 2026-09-25** | 2026-09-25 |
