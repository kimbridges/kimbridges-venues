...
| proj_sake_brewery.md | sake_brewery | Content project (illustrated fiction, "based on a true visit") | **NEW 2026-09-05 / Active / Ready / finishing** — *Three Ways to Let Go of the Rice*: the 2025-05-19 Sasaki Shuzō (Nishijin, Kyoto) tour as a first-person story with reconstructed dialogue; ~6,150 words, 22 photographs, 11 small infographics on sake production and the quality scale. Web version done and approved; **flipbook PDF, cover and stub staged in kimbridges-fiction** (Kim renders + deploys). First work built on Claude Fable 5.1. Source of record `Projects\sake_brewery` (bucket 2) | 2026-09-05 |
