...
**⚠ The pre-ship sweep of `R/` must cover BOTH em dashes and hardcoded chapter numbers** -- each has now shipped from an R string literal. ⚠ **View the PNG before shipping a caption** (two have been wrong about their own figure) **and SEND the PNG to Kim in the same turn** -- he had to ask where the ch.13 maps were. **A figure the author has not seen is not a delivered figure.**

**NEXT: ch.14 `what_the_record_cannot_say.qmd`, the last chapter. ⛔ READ Findings 036, 041, 043, 044, 045 FIRST (Finding 052) -- the four-state argument is its centrepiece and is already fully worked. ⛔ ASK KIM FOR THE TWORED-AT-THE-FLORIDA-CORNER PHOTO; he has found it and offered it. Open: does PEI belong to the province count? Ch.6-ch.11 and ch.13 are still unread by Kim. Nothing is blocking.**

**★★★ CH.13 THE TWO CONSTELLATIONS.** ⚠⚠⚠ **FIRST DRAFT WAS WRONG AND CONTRADICTED THREE SETTLED FINDINGS -- see Finding 052.** I re-derived the state count from the fuel log alone (43) and printed *"FL, RI, SD never witnessed"*; **the project settled 49 of 49 on 2026-08-21.** **Corrected: 43 fills, +MD/VT from the trip log = 45 documented, +DE/RI/SD by arithmetic, +FL by photograph = 49, every state you can drive to.** ★★★ **And Kim closed the rest himself: BC (Haines has one road north and it runs through BC), VT (followed a friend home from his NH office, no stations, couldn't stop), FL (he has found a photo of TWORED at the corner).** ★★★ **His rule is now the chapter's spine: _"I believe in being strict with the data, but circumstances that are clearly explained do count, too."* **A fuel log doesn't record where a car went; it records where a driver bought petrol.** ★★★ **THE PARKING MAP STANDS: 2,209 days, driven on 139 (6.3%); 91.9% in twelve gaps**, three of which hold **12,371 unlogged miles**. ⛔ Map is STATE-LEVEL by design; parking figure is a TIMELINE (Finding 041). ⚠ Ch.14 keeps the four-state argument; ch.13 hands it forward.
<!-- /active-focus -->
