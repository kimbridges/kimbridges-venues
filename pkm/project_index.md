...
| proj_icons.md | icons | Content project, data-driven (register → symbols → stories) | **NEW 2026-09-13 -- ACTIVE FOCUS. Active / Exploring.** Hawai‘i icons: caption-free "Hawai‘i and nothing else" test; channel × origin classification; outsider vs resident sets; density hypothesis. Track R on Kim's machine. Source of record `Projects\icons` (bucket 2): register 40 rows + codebook + photo log; two-tier visual design (posters from Kim's photos via OpenAI API in R; SVG glyphs) | 2026-09-13 |
