...
**⚠ AMENDED 2026-09-01, close of session -- the drift rate, now measured over three more scaffolds.** The ch.10, ch.11 and ch.12 scaffolds were each re-derived before drafting, per this finding's rule. **Seven more numbers had drifted, out of roughly fifteen checked.** ch.10: Creamsicle "143 of 170" is 163 of 169; "3 errata, all resolved" is 5, three still hypotheses. ch.11: lifetime "39.44" reproduces from nothing; Creamsicle median 40.52 not 40.59; wide-tyre CI +2.8% [-0.9, +6.5] not -3.7 to +4.9. ch.12: median leg "251 / 166 mi" is 305 and 273.7; "log distance ~95% of odometer" is a median ratio of 1.00. **★★ Roughly half of every hand-copied scaffold is wrong, and the rate does not fall as the practice gets more careful.** Treat a scaffold number as a placeholder that renders, never as a value.
